pro kinematic_distance, l, b, v, near = near, far = far, rc = rc, $
...
; convert to Heliocentric
  euler,l,b,ra,dec,2
  helio2lsr,vhelio,vlsr,kinematic=kinematic,dynamical=dynamical,$
            ra=ra,dec=dec

; Convert back to LSR with Reid versions of kinematic parameters

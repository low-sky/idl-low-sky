;$Id: moment.pro,v 1.1 2003/10/07 05:06:11 eros Exp $
;
...
;
;       Mon Apr 21 16:39:27 2003, Erik Rosolowsky <eros@cosmic>
;		Hacked so that it can deal with stupid inputs (like
;		the stdev of a 1 element array).  
;       Written by: GGS, RSI, August 1994 Modified: GGS, RSI,
;       September 1995 Added DOUBLE keyword.  Added checking for N
;       identical elements.  Added support for IEEE NaN (Not a
;       Number).  Modified variance formula.  Modified: GGS, RSI,
;       April 1996 Modified keyword checking and use of double
;       precision.  GSL, RSI, August 1997 Added Maxmoment keyword.
;       Modified: Wed Jan 28 13:28:07 1998, Scott Lett, RSI Added NAN
;       keyword.
;
;-
...
;  MESSAGE, "X array must contain 2 OR more elements.", /con

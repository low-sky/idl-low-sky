function modelspec, xin, p, tau11 = tau11,tau22 = tau22, tau33 = tau33, tau44 = tau44
...
; Suppress spectral smoothing for performance.
;;   x = interpol(xin, dindgen(n_elements(xin)), $
;;                dindgen(sfac*n_elements(xin))/sfac-0.5)
;  runspec = interpol(runspec, xin, x)

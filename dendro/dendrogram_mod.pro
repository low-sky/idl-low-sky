; $Id: dendrogram.pro,v 1.5 2005/02/01 20:24:19 scottm Exp $
...
;-------------------------------------------------------------------------
pro dendrogram_mod, clusters, distance, outverts, outconn, $
    LEAFNODES=leafnodes, xlocation = xlocation, height = height
